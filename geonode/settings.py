...
####################
# Settings for default search
####################
DEFAULT_SEARCH_SIZE = 10

# Default search sort options |Most Recent = '-date'|Least Recent = 'date'|A-Z = 'title'|Z-A = '-title'|Most Popular = '-popular_count'
DEFAULT_SEARCH_SORT = '-popular_count'
